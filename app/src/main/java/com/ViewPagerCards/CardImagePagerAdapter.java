...
public class CardImagePagerAdapter extends PagerAdapter implements CardAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        LinearLayout.LayoutParams lyImgParams = (LinearLayout.LayoutParams) imageView.getLayoutParams();
        ...
        HTextView subTitleTxt = view.findViewById(R.id.subTitleTxt);
        TitleTxt.setText(imageList.get(position).get("tTitle"));
        subTitleTxt.setHtml(imageList.get(position).get("tSubtitle"), 0);
        ...
        params.height = mContext.getResources().getDimensionPixelSize(R.dimen._45sdp);
        if (mContext instanceof CommonIntroActivity) {
            subTitleTxt.setGravity(Gravity.START);
            params.height = mContext.getResources().getDimensionPixelSize(R.dimen._22sdp);
        }
