...
public class FoodDeliveryHomeFragment extends BaseFragment implements GetAddressFromLocation.AddressFound, GetLocationUpdates.LocationUpdates, RestaurantAdapter.RestaurantOnClickListener, AppBarLayout.OnOffsetChangedListener, CuisinesAdapter.CuisinesOnClickListener, SwipeRefreshLayout.OnRefreshListener, MainCategoryAdapter.CategoryOnClickListener, RestaurantChildAdapter.RestaurantOnClickListener {
    ...
    private String double_dots = "::";
    private LinearLayout mainDataArea;
    private RelativeLayout topSearchFilterArea;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (requireActivity() instanceof ServiceHomeActivity activity) {
            serviceHomeActivity = activity;
        ...
        if (serviceHomeActivity.obj_userProfile != null) {
            JSONArray serviceArray = generalFunc.getJsonArray("ServiceCategories", serviceHomeActivity.obj_userProfile);

            if (serviceArray != null && serviceArray.length() > 1 && ServiceModule.isDeliverAllOnly()) {
                JSONObject advertise_banner_data = generalFunc.getJsonObject("advertise_banner_data", serviceHomeActivity.obj_userProfile);
        ...
        if (generalFunc.getJsonValueStr("LastOrderFoodDetailRatingShow", serviceHomeActivity.obj_userProfile).equalsIgnoreCase("Yes")) {
        ...
        ratingBar.setOnClickListener(v -> {
            ...
            bn.putBoolean("IS_NEW", generalFunc.getJsonValueStr("LastOrderFoodDetailRatingShow", serviceHomeActivity.obj_userProfile).equalsIgnoreCase("Yes"));

            bn.putString("iOrderId", generalFunc.getJsonValueStr("LastOrderId", serviceHomeActivity.obj_userProfile));
            bn.putString("vOrderNo", generalFunc.getJsonValueStr("LastOrderNo", serviceHomeActivity.obj_userProfile));
            bn.putString("driverName", generalFunc.getJsonValueStr("LastOrderDriverName", serviceHomeActivity.obj_userProfile));
            bn.putString("vCompany", generalFunc.getJsonValueStr("LastOrderCompanyName", serviceHomeActivity.obj_userProfile));
            bn.putString("eTakeaway", generalFunc.getJsonValueStr("LastOrderTakeaway", serviceHomeActivity.obj_userProfile));
        ...
        String Ratings_From_DeliverAll = generalFunc.getJsonValueStr("Ratings_From_DeliverAll", serviceHomeActivity.obj_userProfile);
        ...
        if (Ratings_From_DeliverAll != null && !Ratings_From_DeliverAll.equalsIgnoreCase("") && !Ratings_From_DeliverAll.equalsIgnoreCase("Done")) {
            ...
            manageRecyclviewHeight();
            orderHotelName.setText(generalFunc.getJsonValueStr("LastOrderCompanyName", serviceHomeActivity.obj_userProfile));
        }
        ...
        headerAddressTxt.setHint(generalFunc.retrieveLangLBl("Locating you", "LBL_LOCATING_YOU_TXT"));
        ...
        topSearchFilterArea = view.findViewById(R.id.topSearchFilterArea);
        mainDataArea = view.findViewById(R.id.mainDataArea);
    ...
    private void setData() {
        ...
        if (generalFunc.getJsonValueStr("ENABLE_ITEM_SEARCH_STORE_ORDER", serviceHomeActivity.obj_userProfile).equalsIgnoreCase("Yes")) {
    ...
    private void getRestaurantList(final double latitude, final double longitude, boolean isLoadMore) {
        ...
        topSearchFilterArea.setVisibility(View.VISIBLE);
        viewBg.setVisibility(View.VISIBLE);
        mainDataArea.setVisibility(View.VISIBLE);
...
//                        }
                    ...
                    Logger.e("TRACK", "4" + double_dots + System.currentTimeMillis());

                    if (restaurant_Arr != null && restaurant_Arr.length() > 0) {
                        String LBL_OPEN_NOW = "", LBL_CLOSED_TXT = "", LBL_NOT_ACCEPT_ORDERS_TXT = "";
                        int dimension = 0;
                        Logger.d("TRACK", "5" + double_dots + System.currentTimeMillis());
                        ...
                        Logger.e("TRACK", "6" + double_dots + System.currentTimeMillis());
...
//                            map.put("vImage", vImage);
                    ...
                    Logger.d("TRACK", "7" + double_dots + System.currentTimeMillis());
                    ...
                    if (restaurantArr_List.size() == 0) {
                        ...
                        if (!generalFunc.getJsonValue("message1", responseString).equalsIgnoreCase("")) {
                            ...
                            topSearchFilterArea.setVisibility(View.GONE);
    ...
    public void onResume() {
        ...
        try {
            ...
            if (generalFunc.retrieveValue(Utils.ISWALLETBALNCECHANGE).equalsIgnoreCase("Yes")) {
                ...
                serviceHomeActivity.obj_userProfile = generalFunc.getJsonObject(generalFunc.retrieveValue(Utils.USER_PROFILE_JSON));
            }
            ...
            if (responseString != null && !responseString.equals("")) {
                ...
                if (isDataAvail) {
                    try {
                        ...
                        serviceHomeActivity.obj_userProfile = generalFunc.getJsonObject(userProfileJson);
...
//        swipeRefreshLayout.setRefreshing(false);
    ...
    public void openFilterDilaog() {
        ...
        if (!generalFunc.getMemberId().equalsIgnoreCase("") && generalFunc.getJsonValueStr("ENABLE_FAVORITE_STORE_MODULE", serviceHomeActivity.obj_userProfile).equalsIgnoreCase("Yes")) {
...
//        }
    ...
    public void onClickView(View v) {
        ...
        int id = v.getId();
        if (id == R.id.changeLocBtn || id == R.id.editLocationBtn || id == R.id.headerAddressTxt) {
            ...
            onBackPressed();
        } else if (id == R.id.filterArea) {//                    if (!filterClick) {
//                        filterClick = true;
...
//                    }
            ...
            // openRelevenceDilaog();
        } else if (id == R.id.relevenceTxt) {
            openRelevenceDilaog();
        } else if (id == R.id.noThanksBtn) {
            locationPopup.setVisibility(View.GONE);
