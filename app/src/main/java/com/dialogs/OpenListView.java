...
public class OpenListView {
    ...
    private OpenListView(Context mContext, String title, ArrayList<HashMap<String, String>> arrayList, OpenDirection openDirection, boolean isCancelable, OnItemClickList onItemClickList, boolean isCloseAct) {
        this.mContext = mContext;
        this.title = title;
        this.openDirection = openDirection;
        this.isCancelable = isCancelable;
    ...
    private OpenListView(Context mContext, String title, ArrayList<String> stringArrayList, OpenDirection openDirection, boolean isCancelable, boolean isStringArrayList, OnItemClickList onItemClickList) {
        this.mContext = mContext;
        this.title = title;
        this.openDirection = openDirection;
        this.isCancelable = isCancelable;
    ...
    private void showDialogWithImage(int selectedItemPosition, String keyToShowAsTitle, boolean isStringArrayList) {
        ...
        if (openDirection == OpenDirection.CENTER) {
            ...
            ((RelativeLayout) contentView.findViewById(R.id.main_rl)).setLayoutParams(params);
        }
        if (mListDialog != null) {
        ...
        LayoutDirection.setLayoutDirection(mListDialog);
        ...
        closeImg.setOnClickListener(v -> {
            ...
            mListDialog = null;
            if (isCloseAct) {
                if (!MyApp.getInstance().getCurrentAct().isFinishing()) {
    ...
    private void showDialog(int selectedItemPosition, String keyToShowAsTitle, boolean isStringArrayList) {
        ...
        LayoutDirection.setLayoutDirection(listDialog);
    ...
    public static OpenListView getInstance(Context mContext, String title, ArrayList<HashMap<String, String>> arrayList, OpenDirection openDirection, boolean isCancelable, OnItemClickList onItemClickList, boolean isCloseAct) {
        return new OpenListView(mContext, title, arrayList, openDirection, isCancelable, onItemClickList, isCloseAct);
    }
    ...
    public static OpenListView getInstance(Context mContext, String title, ArrayList<String> arrayList, OpenDirection openDirection, boolean isCancelable, boolean isStringArrayList, OnItemClickList onItemClickList) {
        return new OpenListView(mContext, title, arrayList, openDirection, isCancelable, isStringArrayList, onItemClickList);
    }
