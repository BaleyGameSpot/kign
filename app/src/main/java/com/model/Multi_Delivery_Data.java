...
public class Multi_Delivery_Data implements Serializable {
    ...
    String destAddress = "",destBuilding = "", destApartment = "";
    ...
    public String getDestApartment() {
        return destApartment;
    }

    public void setDestAddress(String destAddress) {
        this.destAddress = destAddress;
    }
    public void setDestBuilding(String detBuilding) {
        this.destBuilding = detBuilding;
    }
    public void setDestAparment(String destApartment) {
        this.destApartment = destApartment;
    }
