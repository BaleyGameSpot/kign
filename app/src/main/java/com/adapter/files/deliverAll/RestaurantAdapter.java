    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof RestaurantAdapter.ViewHolder) {
            ...
            if (generalFunctions.getServiceId().equals("1") || generalFunctions.getServiceId().equalsIgnoreCase("")) {
                ...
                if (!Utils.checkText(Utils.getText(resholder.pricePerPersonTxt))) {
...
//            }
            ...
            if (resholder.pricePerPersonTxt.getVisibility() == View.VISIBLE
                    || resholder.minOrderTxt.getVisibility() == View.VISIBLE
                    || resholder.minOrderLBLTxt.getVisibility() == View.VISIBLE) {

                resholder.timer2Image.setVisibility(View.VISIBLE);
            } else {
