...
//            viewHolder.bookingDateTxt.setText("");
            ...
            //viewHolder.dateTxt.setText(generalFunc.getDateFormatedType(item.get("dDateOrig"), Utils.OriginalDateFormate, DateTimeUtils.getDetailDateFormat(generalFunc)));
            viewHolder.dateTxt.setText(item.get("tDisplayDateTime"));
