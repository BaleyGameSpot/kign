...
import com.act.deliverAll.LoginActivity;
import com.act.deliverAll.SignUpActivity;
...
public class OpenLinkedinDialog {
    ...
    public void show() {
        ...
        WKWebView mWebView = (WKWebView) dialogView.findViewById(R.id.linkedinWebview);
