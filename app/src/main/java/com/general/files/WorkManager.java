    ...
    private static void startScheduledTask() {
        ...
        if (MyApp.getInstance().getCurrentAct() != null && updateScheduleTask == null) {
            MyApp.getInstance().getCurrentAct().runOnUiThread(() -> {
                ...
                updateScheduleTask.setTaskRunListener(recurringTask -> {
...
//                    check();
    ...
    private static void finalProcess() {
        try {
            ...
            new Handler(Looper.getMainLooper()).postDelayed(() -> {
                ...
                MyApp.getInstance().getCurrentAct().getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN);
                ...
                if (MyApp.getInstance().getCurrentAct() != null && MyApp.getInstance().getCurrentAct().getWindow() != null) {
    ...
    private static String getBaseUrl() {
        ...
        try {
            ...
            server_Str = (String) basefield.invoke(null, (Object[]) null) + infofield.invoke(null, (Object[]) null);
        } catch (Exception ignored) {
        }
