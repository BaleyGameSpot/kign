...
public class SetGeneralData {
    ...
    public SetGeneralData(GeneralFunctions generalFunc, JSONObject responseObj) {
        ...
        storeData.put(Utils.APP_SERVICE_URL_KEY, generalFunc.getJsonValueStr("APP_SERVICE_URL", responseObj));
        Utils.APP_SERVICE_URL = generalFunc.getJsonValueStr("APP_SERVICE_URL", responseObj);

        DateTimeUtils.Is24HourTime = generalFunc.getJsonValueStr("ENABLE_24_HOUR_FORMAT", responseObj).equalsIgnoreCase("Yes");
        ...
        if (!generalFunc.getMemberId().equalsIgnoreCase("")) {
            ...
            storeData.put("DRIVER_QUOTATION_ACCEPT_TIME_BID_TAXI", generalFunc.getJsonValueStr("DRIVER_QUOTATION_ACCEPT_TIME_BID_TAXI", responseObj));
            ...
            storeData.put(Utils.DEFAULT_CURRENCY_VALUE, generalFunc.getJsonValue("vCurrencyPassenger", generalFunc.retrieveValue(Utils.USER_PROFILE_JSON)));
        ...
        storeData.put("ENABLE_WHATSAPP_OTP_VERIFICATION", generalFunc.getJsonValueStr("ENABLE_WHATSAPP_OTP_VERIFICATION", responseObj));
