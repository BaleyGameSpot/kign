...
class CircularImageView @JvmOverloads constructor(
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        circleColor =
                attributes.getColor(R.styleable.CircularImageView_civ_circle_color, resources.getColor(R.color.transparent_full))
...
//            setPadding(shadowRadius.toInt(),shadowRadius.toInt(),shadowRadius.toInt(),shadowRadius.toInt());
        }
