 ...
 */
package com.view.zoomimageview;
...
public class ZoomImageView extends AppCompatImageView implements OnScaleGestureListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        doubleTapToZoom = values.getBoolean(R.styleable.ZoomImageView_zoomage_doubleTapToZoom, true);
        ...
        doubleTapToZoomScaleFactor = values.getFloat(R.styleable.ZoomImageView_zoomage_doubleTapToZoomScaleFactor, 3);
