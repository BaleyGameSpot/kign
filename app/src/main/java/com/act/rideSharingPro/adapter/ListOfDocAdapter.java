...
import com.opleq.user.databinding.ListOfDocItemDesignBinding;
...
public class ListOfDocAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof final ViewHolder viewHolder) {
            ...
            if (item.get("doc_file").equalsIgnoreCase("")) {
                ...
                if (Utils.checkText(item.get("DOC_STATUS_TEXT"))) {
                    ...
                    viewHolder.binding.infoImg.setImageDrawable(ContextCompat.getDrawable(viewHolder.itemView.getContext(), R.drawable.ic_check_mark));
                }
