...
import com.opleq.user.databinding.ActivityRideUploadDocBinding;
...
public class RideUploadDocActivity extends ParentActivity {
    ...
    private void setData() {
        ...
        if (Objects.requireNonNull(documentDataHashMap.get("ex_status")).equalsIgnoreCase("Yes")) {
            SELECTED_DATE = documentDataHashMap.get("ex_date");
            binding.dateTimeEditBox.setText(SELECTED_DATE);
    ...
    private void checkData() {
        ...
        isBtnClick = true;
        new Handler(Looper.getMainLooper()).postDelayed(() -> isBtnClick = false, 1000);

        HashMap<String, String> paramsList = new HashMap<String, String>() {{
            put("type", "PublishRideUploadDocuments");
        ...
        if (Utils.checkText(documentDataHashMap.get("doc_file"))) {
            ...
            if (isUploadImageNew) {
                ...
                paramsList.put("existingfilename", selectedDocumentPath);
