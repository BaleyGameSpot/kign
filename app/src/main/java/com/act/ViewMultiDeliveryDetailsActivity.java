    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Utils.checkText(OPEN_CHAT)) {
            ...
            if (OPEN_CHAT_DATA_OBJ != null) {
                ...
                String vBookingNo = generalFunc.getJsonValueStr("vBookingNo", OPEN_CHAT_DATA_OBJ);
                String vRideNo = generalFunc.getJsonValueStr("vRideNo", OPEN_CHAT_DATA_OBJ);

                Bundle bn = new Bundle();
                bn.putString("iTripId", generalFunc.getJsonValueStr("iTripId", OPEN_CHAT_DATA_OBJ));
...
//                                LBL_CANCELED_TRIP_TXT = generalFunc.retrieveLangLBl("", "LBL_CANCELED_TRIP_TXT");
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.backImgView) {
            ...
            recreate();
        } else if (id == R.id.passengerSignTxt) {
            showSignatureImage(data_trip.get("vName") + " " + data_trip.get("vLastName"), senderImage, true);
        }
    }
