...
import com.opleq.user.databinding.ActivityStaticPageBinding;
...
public class StaticPageActivity extends ParentActivity {
    ...
    private void initViews() {
        ...
        if (Utils.checkText(staticData)) {
            binding.toolbarInclude.titleTxt.setText(getIntent().getStringExtra("vTitle"));
            loadAboutUsDetail(staticData);

        } else if (static_page_id.equalsIgnoreCase("1")) {
