...
import com.opleq.user.databinding.ActivityHelpMainCategory23ProBinding;
import com.opleq.user.databinding.ItemDesignCategoryHelpBinding;
import com.opleq.user.databinding.ItemDesignCategoryHelpTitleBinding;
...
public class HelpMainCategory23Pro extends ParentActivity {
    ...
    private void buildHelpTitle(JSONObject obj) {
        ...
        binding1.shadowHeaderView.setVisibility(View.GONE);
